...
namespace ReviewUtil
{
    ...
    {
        /// <summary>
        /// Subject for review request
        /// </summary>
        public const string RequestSubject = "CR: {0} : {1}";
        public const string IterationSubject = "CR: {0} : New revision added - {1}";
        public const string ReminderSubject = "CR: {0} : PING! - {1}";
        public const string WaitingOnAuthorSubject = "CR: {0} : {1} is waiting on author";
        public const string SignedOffSubject = "CR: {0} : {1} has signed off";
        public const string SignedOffWithCommentsSubject = "CR: {0} : {1} has signed off with Comments !!!!";
        public const string CompleteSubject = "CR: {0} : Completed - {1}";
        public const string DeleteSubject = "CR: {0} : Deleted - {1}";

        /// <summary>
        /// Review request body
        /// </summary>
        public const string Request =
            "You have been requested to review change {0}.  Please go to {1} and make your comments there.\n" + 
            "Thank You,\n"+ 
            "{2}\n\n" + 
            "{3}\n"; // description
