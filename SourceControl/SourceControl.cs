...
namespace SourceControl
{
    ...
    {
        public SourceControlRuntimeError(string message)
            : base(message)
        {
    ...
    public sealed class ChangeFile
    {
        ...
        public string LocalOrServerFileName
        {
            get
            {
                return string.IsNullOrEmpty(LocalFileName) ? ServerFileName : LocalFileName;
            }
        }
        ...
        public ChangeFile(string serverFileName, SourceControlAction action, int revision, bool isText, bool isShelved = false)
        {
    ...
    public interface ISourceControl
    {
        ...
        Change GetChange(string changeList, bool includeBranchedFiles, bool skipFiles=false);

        /// <summary>
        /// Gets the pending changes for ther user
        /// </summary>
        /// <returns> The changes. </returns>
        List<Change> GetChanges(string userName);
